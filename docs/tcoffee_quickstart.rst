...
.. warning:: This part is designed to have an quick overview of T-Coffee alignment procedures. 1) All the files mentioned here can be found in the example directory of the distribution. 2) Go to the T-Coffee manual for a more detailed description and available options for a given mode. 3) Go to the T-Coffee tutorial for a practical training on T-Coffee alignment and other functions. 
