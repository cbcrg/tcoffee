...
void
hmm2lib(const Seq::Alignment &aln1, const Seq::Alignment &aln2, const Utils::Matrix<float> &forward_mat, const Utils::Matrix<float> &backward_mat, BioTools::Utils::Library &lib, float total_probability);
 ...
 */
void
all_hmm_pairs(const BioTools::Seq::SequenceSet &set, BioTools::Utils::Library &lib, BioTools::Utils::Matrix<float> &dist_mat, char &seq_type);

void
all_hmm_pairs(const std::vector<BioTools::Seq::Alignment*> &set, BioTools::Utils::Library &lib, BioTools::Utils::Matrix<float> &dist_mat, char &seq_type, size_t start, size_t end);
...
float
hmm_forward(const HMM &hmm, BioTools::Utils::Matrix<float> &ins_probs1, BioTools::Utils::Matrix<float> &ins_probs2, BioTools::Utils::Matrix<float> &match_probs, BioTools::Utils::Matrix<float> &dp_mat, float **insert_matrices);
...
float
hmm_backward(const HMM &hmm, BioTools::Utils::Matrix<float> &ins_probs1, BioTools::Utils::Matrix<float> &ins_probs2, BioTools::Utils::Matrix<float> &match_probs, BioTools::Utils::Matrix<float> &dp_mat, float **insert_matrices);
