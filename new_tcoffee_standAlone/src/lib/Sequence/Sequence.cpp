...
Sequence::Sequence(const std::string &seq_name, const std::string &comment_, const std::string &seq, size_t seq_id): _name(seq_name), _comment(comment_), _sequence(seq), _input_id(seq_id), _aln_id(seq_id), _ocurrence(1)
{
}

Sequence::Sequence(const std::string &seq_name, const std::string &comment_, unsigned int seq_length, size_t seq_id):_name(seq_name), _comment(comment_), _input_id(seq_id), _aln_id(seq_id), _ocurrence(1)
{
	_sequence.reserve(seq_length);
}

Sequence::Sequence(const Sequence &seq):_name(seq._name), _comment(seq._comment), _sequence(seq._sequence), _input_id(seq._input_id), _aln_id(seq._aln_id), _ocurrence(1)
{
}
