...
wget -q --no-check-certificate https://s3-eu-west-1.amazonaws.com/proteinfold-dataset/tcoffee/tcoffee-ci/commandline_tools_os_x_mountain_lion_for_xcode__march_2014.dmg
